    		...
    		<div style="text-align: center;margin:0 auto ">
    				<h2>板块添加</h2>
	          		<div class="form-group">
					    ...
					    <input type="text" name="flate.flateName" class="form-control" id="flateName" placeholder="FlateName">
					</div>
    				...
    				<div class="form-group">
					    ...
					    <textarea rows="10px"  name="flate.flateContent" class="form-control" id="flateContent" ></textarea>
					</div>
